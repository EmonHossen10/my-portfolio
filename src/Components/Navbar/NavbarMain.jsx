...
const NavbarMain = () => {
  ...
  return (
    <nav className="max-w-[1300px] mx-auto w-full  px-4  fixed left-[50%] -translate-x-[50%] z-20 flex gap-2 md:gap-2 mt-2">
      {/* nav body */}
      <div className="flex justify-between w-full  max-w-[1200px] mx-auto  bg-black items-center px-3 md:py-3 rounded-r-full rounded-l-full border-cyan border-[0.5px] ">
        <NavbarLogo />
